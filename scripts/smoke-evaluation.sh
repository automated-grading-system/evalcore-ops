...
[[ "${newman_requests}" == 33 && "${newman_assertions}" == 34 && "${newman_failures}" == 0 ]] || fail "Unexpected Newman results: ${newman_requests} requests / ${newman_assertions} assertions / ${newman_failures} failures."
